...
In all cases varying the AWR over time outperformed keeping it constant. As the new strategies always include some reasoning using \verb|1:1| AWR this suggests that all benefit from \emph{some} fair reasoning during proof search and some biased reasoning. 
