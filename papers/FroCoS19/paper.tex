...
A simple optimisation observation is that sub-goals might well be shared between inferences from all over the search space, so search becomes a directed acyclic graph, alternating between goals and inferences (illustrated in Fig.~\ref{fig:search}).
