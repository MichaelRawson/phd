...
This allows for efficient removal of tedious inferences such as double-negation elimination and generally reduces the search space.
A set of example simplification rules are shown in figure \ref{figure:simplification-rules}.
